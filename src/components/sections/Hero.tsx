    ...
    <section id="top" className="relative overflow-hidden pt-40 pb-24 md:pt-52 md:pb-32">
      ...
      <Container className="relative grid items-center gap-16 lg:grid-cols-[1.1fr_0.9fr] lg:gap-8">
        ...
        >
          ...
          <motion.h1
            variants={blurIn}
            className="font-display text-[clamp(2.5rem,5.4vw,4.4rem)] font-medium leading-[1.05] text-white"
          >
            We solve business
            <br />
            problems with{" "}
          ...
          >
            Hyperplane is not a web design agency. We build AI systems,
            software, and infrastructure that move your business forward —
